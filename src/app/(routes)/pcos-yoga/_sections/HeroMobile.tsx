...
import { Layout } from '../../../components/ui/pages/pcos-yoga/styles/Layout';
        ...
        <Layout>
            ...
            >
                <Box sx={{ flexBasis: '50%' }}>
                    ...
                    <Subtitle>
                        Polycystic Ovary Syndrome (PCOS) is a hormonal disorder affecting those with ovaries. It’s characterised by irregular menstrual cycles, elevated androgen levels, and polycystic ovaries. These symptoms can lead to challenges
                        like acne, weight gain and fertility issues.
                    </Subtitle>
                </Box>
            </Box>
        </Layout>
